...
function roomToAdmin(row: RoomRow, mediaRows: RoomMediaRow[]): Room {
  ...
  return {
    ...
    internalNote: row.internalNote ?? "",
    internalPolicyUrl: row.internalPolicyUrl ?? "",
...
export async function upsertRoom(roomInput: unknown, actorEmail: string) {
  ...
  const room = withAutomaticRoomSeo({
    ...parsed,
    capacity: normalizeRoomCapacity(parsed.capacity),
    pricing: normalizeRoomPricing(parsed.pricing),
    roomCode,
  ...
  await db
    ...
    .onConflictDoUpdate({
      ...
      set: {
        ...
        childAgeMax: values.childAgeMax,
        bedrooms: values.bedrooms,
        bathrooms: values.bathrooms,
        beds: values.beds,
        supplierId: values.supplierId,
        supplierPrice: values.supplierPrice,
        weekdaySupplierPrice: values.weekdaySupplierPrice,
        specialSupplierPrice: values.specialSupplierPrice,
        commissionType: values.commissionType,
        commissionValue: values.commissionValue,
        referencePrice: values.referencePrice,
        weekdayCustomerPrice: values.weekdayCustomerPrice,
        specialCustomerPrice: values.specialCustomerPrice,
        priceUnit: values.priceUnit,
        weekdayPriceUnit: values.weekdayPriceUnit,
        specialPriceUnit: values.specialPriceUnit,
        weekdayUnitCount: values.weekdayUnitCount,
        specialUnitCount: values.specialUnitCount,
        weekdayDays: values.weekdayDays,
        ...
        internalPolicyUrl: values.internalPolicyUrl,
